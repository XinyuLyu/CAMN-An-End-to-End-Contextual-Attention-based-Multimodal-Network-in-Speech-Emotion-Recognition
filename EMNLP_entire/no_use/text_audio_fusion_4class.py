...
for i in range(size_f):
    ...
    acc_audio_test.append(acc_f)
    print('epoch: ', str(i))
    print('loss_f', loss_f, ' ', 'acc_f', acc_f)
    if acc_f >= final_acc:
        final_model.save_weights(r'E:\Yue\Code\ACL_entire\validation\fusion_model_4_class.h5')
        final_acc = acc_f
...
save_list(r'E:\Yue\Code\ACL_entire\validation\acc_audio.txt', acc_audio_train)
save_list(r'E:\Yue\Code\ACL_entire\validation\loss_audio.txt', loss_audio_train)
save_list(r'E:\Yue\Code\ACL_entire\validation\acc_text.txt', acc_text_train)
save_list(r'E:\Yue\Code\ACL_entire\validation\loss_text.txt', loss_text_train)
save_list(r'E:\Yue\Code\ACL_entire\validation\loss_fusion.txt', loss_fusion_train)
save_list(r'E:\Yue\Code\ACL_entire\validation\acc_fusion.txt', acc_fusion_train)

plt.subplot(1,3,1)
plt.title('audio')
plt.plot(epoch_audio, loss_audio_train, label='loss')
plt.plot(epoch_audio, acc_audio_train, label='acc')
plt.xlabel("epoch")
plt.ylabel("audio loss and acc")
plt.legend()
plt.subplot(1,3,2)
plt.title('text')
plt.plot(epoch_text, loss_text_train, label='loss')
plt.plot(epoch_text, acc_text_train, label='acc')
plt.xlabel("epoch")
plt.ylabel("text loss and acc")
plt.legend()
plt.subplot(1,3,3)
plt.title('fusion')
plt.plot(epoch_fusion, loss_fusion_train, label='loss')
plt.plot(epoch_fusion, acc_fusion_train, label='acc')
plt.xlabel("epoch")

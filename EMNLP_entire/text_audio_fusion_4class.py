...
from DataLoader_audio_7380 import *  # process_train_data
...
audio_att1 = Dropout(0.05)(audio_att)
audio_att1 = Attention(4, 10)([audio_att1, audio_att1, audio_att1])
audio_att1 = Dropout(0.05)(audio_att1)
...
word_att1 = Dropout(0.05)(word_att)
word_att1 = Attention(4, 10)([word_att1, word_att1, word_att1])
word_att1 = Dropout(0.05)(word_att1)
word_att_gap = GlobalMaxPooling1D()(word_att1)
...
activation1 = Activation('relu')(d_1)
d_drop1 = Dropout(0.1)(activation1)
d_2 = Dense(128)(d_drop1)
activation2 = Activation('relu')(d_2)
d_drop2 = Dropout(0.1)(activation2)

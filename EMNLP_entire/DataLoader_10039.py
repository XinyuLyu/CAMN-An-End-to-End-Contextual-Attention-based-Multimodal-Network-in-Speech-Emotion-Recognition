...
from data import load_data_audio, save_data_audio
...
def get_data():
    ...
    save_data_audio(train_audio_data, train_text_data, train_label, test_audio_data, test_text_data, test_label, test_label_o)
...
def get_data1():
    dic = get_dictionary(dic_path)
    embed_matrix = initial_embed(dic, embed_path)
    train_audio_data, train_text_data, train_label, test_audio_data, test_text_data, test_label, test_label_o = load_data_audio()
    return train_audio_data, train_text_data, train_label, test_audio_data, test_text_data, test_label, test_label_o, embed_matrix, dic
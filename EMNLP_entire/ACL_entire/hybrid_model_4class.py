...
from DataLoader_hybrid_4class import get_data
from DataLoader_hybrid_4class import data_generator
from DataLoader_hybrid_4class import data_generator_output
from DataLoader_hybrid_4class import analyze_data
...
fusion_att_a = Dense(64, kernel_regularizer=rl.l2(0.01))(fusion_att_a)
fusion_att_a = BatchNormalization()(fusion_att_a)
fusion_att_a = Activation('relu')(fusion_att_a)
fusion_att_t = Dense(64, kernel_regularizer=rl.l2(0.01))(fusion_att_t)
...
fusion_att_concat = Dense(64, kernel_regularizer=rl.l2(0.01), activity_regularizer=rl.l2(0.001))(fusion_att_concat)
fusion_att_concat = BatchNormalization()(fusion_att_concat)
fusion_att_concat = Activation('relu')(fusion_att_concat)
fusion_att_concat = Dense(32, kernel_regularizer=rl.l2(0.01), activity_regularizer=rl.l2(0.001))(fusion_att_concat)
fusion_att_concat = BatchNormalization()(fusion_att_concat)
fusion_att_concat = Activation('relu')(fusion_att_concat)
fusion_att_concat = Dense(16, kernel_regularizer=rl.l2(0.01), activity_regularizer=rl.l2(0.001))(fusion_att_concat)
fusion_att_concat = BatchNormalization()(fusion_att_concat)
fusion_att_concat = Activation('relu')(fusion_att_concat)

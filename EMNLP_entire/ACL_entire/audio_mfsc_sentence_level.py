...
audio_path = 'E:\Yue\Entire Data\iemocap_ACMMM_2019\MFSC_source\IEMOCAP_Mat_64_7204\\'
...
audio_input = Input(shape=(64, 600))
...
# retrain
audio_model.load_weights(r'E:\Yue\Code\ACL_entire\audio_mfsc_sentence\audio_model_4_class.h5')
...
for i in range(size):
    ...
    if loss_a <= audio_loss:
        audio_model.save_weights(r'E:\Yue\Code\ACL_entire\audio_mfsc_sentence\audio_model_4_class.h5')
        audio_acc = acc_a
        audio_loss = loss_a
print(audio_loss, audio_acc)
...
plt.legend()
plt.show()
save_list(r'E:\Yue\Code\ACL_entire\audio_mfsc_sentence\acc_test.txt', acc_test)
save_list(r'E:\Yue\Code\ACL_entire\audio_mfsc_sentence\loss_test.txt', loss_test)
save_list(r'E:\Yue\Code\ACL_entire\audio_mfsc_sentence\acc_train.txt', acc_train)
save_list(r'E:\Yue\Code\ACL_entire\audio_mfsc_sentence\loss_train.txt', loss_train)
